...
if(NOT STELLAR_SURFACE_ART_SCHEMA EQUAL 1 OR NOT STELLAR_SURFACE_ART_COUNT EQUAL 5)
  message(FATAL_ERROR "Unsupported native surface art asset declaration")
endif()
add_custom_target(stellar_native_surface_art_assets)
foreach(STELLAR_SURFACE_ART_KEY IN ITEMS temperate-ground-albedo-v1 credits planetary-panorama planetary-buildings planetary-credits)
  if(STELLAR_SURFACE_ART_KEY STREQUAL "temperate-ground-albedo-v1")
    ...
    set(STELLAR_SURFACE_ART_EXPECTED_RUNTIME
      "assets/visual/surface/temperate-ground-albedo-v1.png")
  elseif(STELLAR_SURFACE_ART_KEY STREQUAL "planetary-panorama")
    set(STELLAR_SURFACE_ART_EXPECTED_SOURCE "assets/visual/planetary/colony-panorama-v1.png")
    set(STELLAR_SURFACE_ART_EXPECTED_RUNTIME "${STELLAR_SURFACE_ART_EXPECTED_SOURCE}")
  elseif(STELLAR_SURFACE_ART_KEY STREQUAL "planetary-buildings")
    set(STELLAR_SURFACE_ART_EXPECTED_SOURCE "assets/visual/planetary/building-portraits-v1.png")
    set(STELLAR_SURFACE_ART_EXPECTED_RUNTIME "${STELLAR_SURFACE_ART_EXPECTED_SOURCE}")
  elseif(STELLAR_SURFACE_ART_KEY STREQUAL "planetary-credits")
    set(STELLAR_SURFACE_ART_EXPECTED_SOURCE "assets/visual/planetary/ARTWORK.md")
    set(STELLAR_SURFACE_ART_EXPECTED_RUNTIME "Licenses/Planetary-art-sources.md")
  else()
    set(STELLAR_SURFACE_ART_EXPECTED_SOURCE
