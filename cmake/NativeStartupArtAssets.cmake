...
if(NOT STELLAR_STARTUP_ART_SCHEMA EQUAL 1 OR NOT STELLAR_STARTUP_ART_COUNT EQUAL 10)
  message(FATAL_ERROR "Unsupported native startup art asset declaration")
endif()
add_custom_target(stellar_native_startup_art_assets)
foreach(STELLAR_STARTUP_ART_KEY IN ITEMS stellar-continuum-splash stellar-loading-splash stellar-galaxy-generation stellar-save-loading title-logo galaxy-card empire-emblem galaxy-view system-view credits)
  ...
  elseif(STELLAR_STARTUP_ART_KEY STREQUAL "galaxy-view" OR STELLAR_STARTUP_ART_KEY STREQUAL "system-view")
    set(STELLAR_STARTUP_ART_EXPECTED_SOURCE "assets/visual/hud/${STELLAR_STARTUP_ART_KEY}.png")
    set(STELLAR_STARTUP_ART_EXPECTED_RUNTIME "${STELLAR_STARTUP_ART_EXPECTED_SOURCE}")
  elseif(STELLAR_STARTUP_ART_KEY STREQUAL "empire-emblem")
    set(STELLAR_STARTUP_ART_EXPECTED_SOURCE "assets/visual/branding/stellar-continuum-icon-v1.png")
    set(STELLAR_STARTUP_ART_EXPECTED_RUNTIME "${STELLAR_STARTUP_ART_EXPECTED_SOURCE}")
  elseif(STELLAR_STARTUP_ART_KEY STREQUAL "title-logo")
    set(STELLAR_STARTUP_ART_EXPECTED_SOURCE "assets/visual/branding/stellar-continuum-title-v1.png")
    set(STELLAR_STARTUP_ART_EXPECTED_RUNTIME "${STELLAR_STARTUP_ART_EXPECTED_SOURCE}")
  elseif(STELLAR_STARTUP_ART_KEY STREQUAL "galaxy-card")
    set(STELLAR_STARTUP_ART_EXPECTED_SOURCE "assets/visual/space/campaign-galaxy-four-arm-v1.png")
    set(STELLAR_STARTUP_ART_EXPECTED_RUNTIME "${STELLAR_STARTUP_ART_EXPECTED_SOURCE}")
  else()
