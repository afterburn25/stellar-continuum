...
| 11 | Space-specific rendering | PARTIAL | Native scene3d GPU path, planet/ring/star materials; **HDR/tonemap resolve landed** (RGBA16F scene targets + fullscreen resolve, capability-checked with UNORM fallback); instancing, render-graph backend consumption, TextureStreamer residency pending. |
