...
- **Limitations:** the deck is a texture-space composite — no volumetric
  cloud shells, cloud self-shadowing or gas-giant banding; wrap and limb
  darkening are single-coefficient laws, not wavelength-dependent
  models.
