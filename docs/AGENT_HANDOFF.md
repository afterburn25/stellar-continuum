...
pointer path. Open: an accessibility input layer and device-policy/
focus-capture tests — the picker speaks slot numbers, not connected-pad
names, since the platform does not yet expose pad identity.
