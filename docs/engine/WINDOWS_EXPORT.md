...
Engine 0.1.51 adds two maintained colony launches: fresh 720p input and paused 1080p reload. The proof verifies observer-safe ownership, selected body/colony, current reserves and power, complete save identity, and Back/Pause/Speed behavior. Two colony flags bring the total to 34, with two colony captures as sidecars. Combined checks passed 135 CTest, 134 Python checks and eighteen actual Vulkan launches. See NATIVE_COLONY_WORKSPACE.md and NATIVE_BUILD_BUDGET.md.
